...
class PaymentSettings extends \XLite\Controller\Admin\PaymentSettings implements \XLite\Base\IDecorator
{
    ...
    protected function doActionAdd()
    {
        ...
        if (
            ...
            $this->setReturnURL($this->buildURL('xpc', '', array('section' => \XLite\Module\CDev\XPaymentsConnector\Core\Settings::SECTION_WELCOME)));
    ...
    {
        if (\XLite\Module\CDev\XPaymentsConnector\Core\Settings::getInstance()->checkUpdateAllowedModules()) {
