...
class XPaymentsClient extends \XLite\Base\Singleton
{
     ...
     * @param boolean            forZeroAuth Is this a zero-dollar authorization
     *
     * @return array
     */
    public function prepareCart(\XLite\Model\Order $cart, $refId = null, $forceAuth = false, $forZeroAuth = false)
    {
        $config = \XLite\Core\Config::getInstance()->CDev->XPaymentsConnector;
        ...
        if (
            ...
            $result['items'][] = array(
                ...
                'price'    => $config->xpc_zero_auth_amount,
                'quantity' => '1',
            );
        }
