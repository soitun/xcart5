...
core.bind(
  ...
  function(event, data) {
    ...
    jQuery('.model-is-defined', $wrapper).html(data.data.selected_sku).removeClass('hidden');
...
CommonElement.prototype.handlers.push(
  {
    ...
    handler: function() {
      jQuery('.model-selector.data-type-product .model-not-defined').removeClass('hidden');
    }
  }
);
