      ...
      <h2>{t(#Your account settings#)}</h2>
        ...
        <ul class="options">
          ...
          <li>
            ...
            <input type="text" id="pp_partner" name="settings[partner]" value="{paymentMethod.getSetting(#partner#)}" class="validate[required,maxSize[255]]" />
            <widget
          ...
          <li>
            ...
            <input type="text" id="pp_vendor" name="settings[vendor]" value="{paymentMethod.getSetting(#vendor#)}" class="validate[required,maxSize[255]]" />
            <widget
              class="\XLite\View\Tooltip"
              id="pp-vendor-help"
          ...
          <li>
            ...
            <input type="text" id="pp_user" name="settings[user]" value="{paymentMethod.getSetting(#user#)}" class="validate[required,maxSize[255]]" />
            <widget
              class="\XLite\View\Tooltip"
              id="pp-vendor-help"
              text="{t(#PayPal recommends entering a User Login here instead of your Merchant Login#)}"
              caption=""
              isImageTag="true"
              className="help-icon" />
          </li>
          ...
          <li>
            ...
            <input type="text" id="pp_pwd" name="settings[pwd]" value="{paymentMethod.getSetting(#pwd#)}" class="validate[required,maxSize[255]]" />
            <widget
              class="\XLite\View\Tooltip"
              id="pp-vendor-help"
