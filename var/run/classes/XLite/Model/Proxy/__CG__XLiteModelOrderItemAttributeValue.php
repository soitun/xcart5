...
class AttributeValue extends \XLite\Model\OrderItem\AttributeValue implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::getActualAttributeValue();
    }
    ...
    {
        $this->__load();
        return parent::setAttributeValueId($attributeValueId);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'value', 'attributeId', 'attributeValueId', 'orderItem', 'attributeValueC', 'attributeValueS', 'attributeValueT');
    }
