 ...
 * Top menu widget
 */
abstract class TopMenu extends \XLite\View\Menu\Admin\TopMenuAbstract implements \XLite\Base\IDecorator
{
    /**
    ...
    protected function defineItems()
    {
        ...
        $items['content'][self::ITEM_CHILDREN ] += array(
            'menus' => array(
                self::ITEM_TITLE      => 'Menus',
                self::ITEM_TARGET     => 'menus',
                self::ITEM_PERMISSION => 'manage menus',
                self::ITEM_WEIGHT     => 100,
            ),
            'pages' => array(
                self::ITEM_TITLE      => 'Pages',
                self::ITEM_TARGET     => 'pages',
